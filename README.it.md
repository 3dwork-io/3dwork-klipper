...
L'impiego di[STORTO](../../guias-impresion-3d/calibracion_3d.md#7.-pasos-ejes) para la corrección o ajuste preciso de nuestras impresoras es extremadamente aconsejable si tenemos desviaciones en nuestras impresiones. Usando la siguiente variable podemos permitir el uso en nuestras macros:
...
| \_USER_RIPRENDERE_FINE     | Eseguito alla fine di un RESUME  |
