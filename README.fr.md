...
[![English](https://flagcdn.com/w40/gb.png)](README.en.md)[![Deutsch](https://flagcdn.com/w40/de.png)](README.de.md)[![Italiano](https://flagcdn.com/w40/it.png)](README.it.md)[![Español](https://flagcdn.com/w40/es.png)](README.fr.md)[![Português](https://flagcdn.com/w40/pt.png)](README.pt.md)
...
-   L'utilisation de**[sauvegarder_]**, dans notre cas, nous utiliserons ~ / variables.cfg pour stocker les variables et qui est déjà dans le CFG de ces macros.  
    Cela créera automatiquement un fichier variables_build_sheets.cfg où vous conserverez nos variables de disque.
