...
compile_octopus_pro_446() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-octopus-pro-446/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_octopus_pro_429() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-octopus-pro-429/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_octopus_11() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-octopus-11/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_octopus_11_407() {
    echo "Compiling firmware for BTT Octopus v1.1"
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-octopus-11-407/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_fysetc_spider() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/fysetc-spider/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_skr_pro_12() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-skr-pro-12/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_skr_2_429() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-skr-2-429/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_ebb42_10() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-ebb42-10/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_ebb36_10() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-ebb36-10/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_ebb42_11() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-ebb42-11/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_ebb36_11() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-ebb36-11/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_ebb42_12() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-ebb42-12/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_ebb36_12() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-ebb36-12/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_mellow_fly_sht_42() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/mellow-fly-sht-42/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_mellow_fly_sht_36() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/mellow-fly-sht-36/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_skr_mini_e3_30() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-skr-mini-e3-30/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
...
compile_btt_skr_3() {
    ...
    cp -f /home/pi/printer_data/config/3dwork/boards/btt-skr-3/firmware.config /home/pi/klipper/.config
    make olddefconfig
    make clean
    make
