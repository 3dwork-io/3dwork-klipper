...
update_rpi() {
    echo "Updating RPi"
    /home/pi/printer_data/config/3dwork/boards/rpi/make-and-flash-mcu.sh
}
...
update_octopus_pro_446() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-octopus-pro-446/make-and-flash-mcu.sh
    fi
}
...
update_octopus_pro_429() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-octopus-pro-429/make-and-flash-mcu.sh
    fi
}
...
update_btt_octopus_11() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-octopus-11/make-and-flash-mcu.sh
    fi
}
...
update_btt_octopus_11_407() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-octopus-11-407/make-and-flash-mcu.sh
    fi
}
...
update_fysetc_spider() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/fysetc-spider/make-and-flash-mcu.sh
    fi
}
...
update_skr_pro_12() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-skr-pro-12/make-and-flash-mcu.sh
    fi
}
...
update_skr_2_429() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-skr-2-429/make-and-flash-mcu.sh
    fi
}
...
update_btt_ebb36_10() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-ebb42-10/make-and-flash-mcu.sh
    fi
}
...
update_btt_ebb42_11() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-ebb42-11/make-and-flash-mcu.sh
    fi
}
...
update_btt_ebb36_11() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-ebb36-11/make-and-flash-mcu.sh
    fi
}
...
update_btt_ebb42_12() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-ebb42-12/make-and-flash-mcu.sh
    fi
}
...
update_btt_ebb36_12() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-ebb36-12/make-and-flash-mcu.sh
    fi
}
...
update_mellow_fly_sht_42() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/mellow-fly-sht-42/make-and-flash-mcu.sh
    fi
}
...
update_mellow_fly_sht_36() {
    ...
    then
        echo "Mellow FLY-SHT42 detected"
        /home/pi/printer_data/config/3dwork/boards/mellow-fly-sht-36/make-and-flash-mcu.sh
    fi
}
...
update_btt_skr_mini_e3_30() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-skr-mini-e3-30/make-and-flash-mcu.sh
    fi
}
...
update_btt_skr_3() {
    ...
    then
        ...
        /home/pi/printer_data/config/3dwork/boards/btt-skr-3/make-and-flash-mcu.sh
    fi
}
...
then
    ...
    echo "Failed to symlink extensions, ignore this if not on 3dwork 2.0 yet"
fi
